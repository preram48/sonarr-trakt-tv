...
module.exports = "<div style=\"text-align: right;\">\n  <button mat-button (click)=\"close()\">\n    <mat-icon>close</mat-icon>\n  </button>\n</div>\n<form novalidate style=\"text-align: center\">\n  <mat-form-field>\n    <input matInput placeholder=\"Name\" required [(ngModel)]=\"listItem.name\" name=\"name\">\n  </mat-form-field>\n  <mat-form-field>\n    <mat-select placeholder=\"List Type\" [(ngModel)]=\"listItem.listType\" name=\"list\">\n      <mat-option *ngFor=\"let item of trakList\" [value]=\"item.value\" required>\n        {{ item.viewValue }}\n      </mat-option>\n    </mat-select>\n  </mat-form-field>\n  <mat-form-field>\n    <mat-select placeholder=\"Quality Profile\" [(ngModel)]=\"listItem.profile\" name=\"profile\">\n      <mat-option *ngFor=\"let profile of profiles\" [value]=\"profile.id\" required>\n        {{ profile.name }}\n      </mat-option>\n    </mat-select>\n  </mat-form-field>\n  <mat-form-field>\n    <mat-select placeholder=\"Folder\" [(ngModel)]=\"listItem.folder\" name=\"folder\">\n      <mat-option *ngFor=\"let folder of folders\" [value]=\"folder.path\" required>\n        {{ folder.path }}\n      </mat-option>\n    </mat-select>\n  </mat-form-field>\n  <mat-form-field>\n    <input matInput placeholder=\"Username\" [(ngModel)]=\"listItem.username\" name=\"username\">\n  </mat-form-field>\n  <div>\n    <button (click)=\"saveList(listItem)\" mat-raised-button color=\"primary\">save</button>\n  </div>\n</form>"
